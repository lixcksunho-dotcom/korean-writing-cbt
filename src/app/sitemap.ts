...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = ['', '/try', ...TRIAL_TOPICS.map(t => `/try?t=${t.slug}`), '/word-counter', '/exam-info', '/kbs-korean', '/spelling', '/business-writing', '/essay-guide', '/manuscript-guide', '/exam-compare', '/idioms', '/proverbs', '/expressions', '/refined-words', '/honorifics', '/standard-words', '/loanword-spelling', '/guides', '/blog', '/subscribe', '/login', '/signup', '/terms', '/privacy', '/refund', '/support']
