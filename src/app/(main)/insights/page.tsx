        ...
        <div className="flex items-end gap-1.5 h-40 border-b border-[#f1f5f9] pb-0">
          {trend.map((t, i) => (
            <div key={i} className="flex-1 flex flex-col items-center justify-end gap-1 min-w-0">
              <span className="text-[10px] font-bold text-[#64748b] tabular-nums">{t.pct}</span>
              <div
...
function BackLink() {
  return (
    <Link href="/dashboard" className="inline-flex items-center gap-1.5 py-1.5 text-sm text-[#64748b] hover:text-[#1e3a5f] mb-5">
