  ...
  return (
    <div className="animate-fade-up">
        ...
        completedSessions.length === 0 ? (
          ...
          <div className="relative overflow-hidden rounded-2xl mb-8 p-6 border border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50">
            ...
            <div className="relative">
              ...
              <Link href="/cbt" className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-gradient-to-r from-amber-500 to-[#d97706] text-[#0f172a] text-sm font-black hover:opacity-90 transition-opacity">
      ...
      <div className={`grid ${cfg.hasManuscript ? 'md:grid-cols-2' : 'grid-cols-1'} gap-4 mb-8`}>
        <Link href="/cbt" className="group card-hover bg-white rounded-2xl p-6 border border-[#e2e8f0] shadow-[0_4px_16px_rgba(15,31,61,0.06)] block py-3">
      ...
      {completedSessions.length > 0 && (
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-[0_4px_16px_rgba(15,31,61,0.06)] overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#f1f5f9]">
            ...
            <Link href="/cbt" className="text-xs text-[#1e3a5f] font-medium hover:underline flex items-center gap-0.5 py-3">
  ...
  return (
    <div className="relative pt-5">
      <div className="absolute top-0" style={{ left: `${pos}%`, transform: "translateX(-50%)" }}>
        <div className="text-xs font-black text-[#1e3a5f] whitespace-nowrap text-center">{predicted}</div>
