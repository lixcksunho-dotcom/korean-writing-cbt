      ...
      <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-[0_4px_16px_rgba(15,31,61,0.06)] p-6 md:p-8">
        ...
        {!answered ? (
          <div className="grid grid-cols-2 gap-3">
            ...
            <button aria-label="닫기" onClick={() => answer(false)} className="flex items-center justify-center gap-2 py-5 rounded-2xl border-2 border-red-200 text-red-700 font-black text-xl hover:bg-red-50 transition-colors">
