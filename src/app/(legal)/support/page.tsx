...
const FAQS = [
  ...
  {
    q: '유료인데 AI 첨삭이 하루 30회에서 막혔어요',
    a: '이용권 기간 중 횟수 제한은 없지만, 계정 공유와 자동화·대량 이용을 막기 위해 하루 30회까지만 받을 수 있어요(서술형 9문항 기준 모의고사 3회 분량). 한국 시간 자정에 다시 열립니다. 정상 이용인데 더 필요하시면 고객센터로 알려 주세요.',
  },
  {
    q: '회원 탈퇴는 어떻게 하나요?',
