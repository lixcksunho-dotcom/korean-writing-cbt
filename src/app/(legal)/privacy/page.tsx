    ...
    <div className="text-[#334155] text-[15px] leading-7">
      ...
      <Section title="1. 수집하는 개인정보 항목">
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>블로그 후기 이벤트 참여: 참여자가 직접 입력한 <b>블로그 글 주소</b>와 그 글의
            공개 여부·조건 충족 여부 확인 결과. 글 본문은 확인 시점에만 읽고 저장하지 않습니다.</li>
      ...
      <Section title="2. 개인정보의 수집·이용 목적">
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>이벤트 참여 자격 확인 및 이용권 지급·회수(지급 후에도 글이 유지되는지 주기적으로 확인)</li>
