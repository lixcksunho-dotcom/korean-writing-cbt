  ...
  return (
    <div className="text-[#334155] text-[15px] leading-7">
      ...
      <Section title="제6조 (유료서비스 및 결제)">
        <ul className="list-disc pl-5 space-y-1">
          <li>AI 채점·분석 구독의 이용요금은 30일권 5,000원(부가세 포함)입니다.</li>
      ...
      <Section title="제8조 (이용자의 의무)">
        ...
        유발하거나, 타인의 권리를 침해하는 행위를 하여서는 안 됩니다.
      </Section>

      <Section title="제9조 (저작권 및 콘텐츠)">
        서비스가 제공하는 문제·해설·AI 채점 결과 등의 저작권은 회사 또는 정당한 권리자에게 있으며,
        이용자가 작성한 글의 저작권은 이용자에게 있습니다. 회사는 서비스 제공 및 개선 목적의 범위에서만
        이용자 작성물을 처리합니다.
      </Section>
