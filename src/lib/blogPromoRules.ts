 ...
 *  처음엔 5명만 받았다(운영자 지시 2026-09-08) — 남이 쓴 글로 지급까지 실제로 도는 것을
 *  눈으로 확인했다. 2026-09-16 시험(제121회 D-3)을 앞두고 10으로, 이튿날 20으로 늘렸다(운영자 지시 2026-09-17).
 *  이 값만 올리면 화면·자동지급·관리자 승인이 함께 따라온다. */
