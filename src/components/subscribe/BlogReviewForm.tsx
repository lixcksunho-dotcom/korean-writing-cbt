      ...
      <div className="mb-4 rounded-lg border border-[#e2e8f0] bg-white p-3.5 text-xs leading-relaxed text-[#475569]">
        ...
        <ul className="space-y-1">
          <li>
            ...
            그 안에 비공개로 돌리거나 지우면 <b>이용권을 회수하고, 이 이벤트에는 다시 신청하실 수 없어요.</b>
            다시 공개해도 자동으로 되살아나지 않습니다 — 실수였다면 고객센터로 알려 주세요(확인 후 풀어 드려요).
          </li>
          <li>· 광고 표시를 지우셔도 같은 방식으로 회수됩니다(법정 의무라 그래요).</li>
